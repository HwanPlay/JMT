...
import Group from '../components/Profile/Group.vue'
import Something from '../components/Profile/Something.vue'
import Meeting from '../components/Profile/Meeting.vue'
